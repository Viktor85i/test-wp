            ...
            <ul class="trainers-list">
                ...
                <li class="trainers-list__item">
                    <article class="trainer">
                        <img src="<?php echo get_field('trainer_photo')['url']; ?>" alt="<?php echo get_field('trainer_photo')['alt']; ?>" class="service__img">
                        <div class="trainer__wrap">
                            <h2 class="trainer__name"> <?php the_title(); ?> </h2>
                            <p class="trainer__text"> <?php echo the_field('trainer_description'); ?> </p>
                        </div>
