...
class SI_Widget_Social_Links extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            ...
            'SportIsland - Social Links',
            [
                'name' => 'SportIsland - Social Links',
                'description' => 'Выводит ссылки на соцсети'
            ]
...
?>
     <p>
         <label for="<?php echo $this->get_field_id('id-link')?>">Ссылка на соц. сеть:</label>
         <input
